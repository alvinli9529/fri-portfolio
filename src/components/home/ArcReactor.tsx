 ...
 * [OUTPUT]: ArcReactor — XP-style window with video core, rings, uptime
...
export default function ArcReactor({ fragments = [] }: { fragments?: string[] }) {
  ...
  return (
    ...
    >
      {/* XP-style window titlebar for the center area */}
      <div className="xp-titlebar shrink-0">
        ...
        <div
          ...
          style={{ fontSize: '10px', fontFamily: 'Tahoma, sans-serif', color: 'rgba(255,255,255,0.8)' }}
        >
      ...
      <div ref={containerRef} className="flex-1 relative flex items-center justify-center overflow-hidden">
        {/* Crosshair grid — subtle blue on black */}
        <div className="absolute inset-0 pointer-events-none" style={{ borderColor: 'rgba(49, 104, 213, 0.12)' }}>
        ...
        <div className="arc-reactor relative z-10">
          ...
          <div className="absolute -bottom-10 md:-bottom-12 text-center">
            <div
              ...
              style={{ fontFamily: 'Tahoma, sans-serif', fontSize: '10px', letterSpacing: '0.15em' }}
            >
              {status || "FRI CORE"}
            </div>
          </div>
        ...
        {/* Uptime display — XP properties panel style */}
        <div
        ...
        >
          <div style={{ fontSize: '9px', color: '#6090d0', marginBottom: '2px', textTransform: 'uppercase' }}>
            Cumulative runtime
          </div>
          <div style={{ fontSize: '12px', color: '#80c0ff', fontWeight: 'bold' }}>
            {uptime}
          </div>
        </div>
      </div>

      {/* XP media player bottom controls bar */}
      <div
        ...
        >
          <div
            style={{
              height: '100%',
              width: '35%',
              background: 'linear-gradient(90deg, #1040a0, #3168d5)',
            }}
          />
        </div>
        <span style={{ fontFamily: 'Lucida Console, monospace', fontSize: '9px', color: '#6090d0' }}>
          LIVE FEED
        </span>
      </div>
    </div>
