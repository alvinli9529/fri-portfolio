/**
 * [INPUT]: @/components/ui/TechBorder, props from page.tsx
 * [OUTPUT]: Diagnostics — XP-style right-column panel with real stats and service statuses
    ...
    <TechBorder>
      ...
      <div className="p-4">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="text-center p-2" style={{ background: '#ffffff', border: '1px inset', borderColor: '#d4d0c8', boxShadow: 'inset 1px 1px 0 #808080, inset -1px -1px 0 #ffffff' }}>
              <div style={{ fontFamily: 'Tahoma, sans-serif', fontSize: '9px', color: '#595959', marginBottom: '4px', textTransform: 'uppercase' }}>
                This Week
              </div>
              <div style={{ fontFamily: 'Tahoma, sans-serif', fontSize: '22px', fontWeight: 'bold', color: '#0a246a' }}>
                {thisWeekCount}
              </div>
            </div>
            <div className="text-center p-2" style={{ background: '#ffffff', border: '1px inset', borderColor: '#d4d0c8', boxShadow: 'inset 1px 1px 0 #808080, inset -1px -1px 0 #ffffff' }}>
        ...
        >
          ...
          <div
            className="flex items-end gap-[2px] p-1"
            style={{ height: '80px' }}
              ...
              <div
                ...
                style={{
                  ...
                  background: hovered === i
                    ? "#5ca0ff"
                    : hovered !== null
                      ? day.count > 0 ? "#2060c0" : "#103060"
                      : day.count > 0 ? "#3168d5" : "#102040",
                }}
        ...
        {/* Service status list — XP list view style */}
        <div
          style={{
            border: '1px solid #848484',
          ...
          {services.map((svc, i) => (
            <div
              ...
              style={{
                ...
                padding: '3px 6px',
                borderBottom: i < services.length - 1 ? '1px solid #d4d0c8' : 'none',
                fontFamily: 'Tahoma, sans-serif',
                fontSize: '10px',
                display: 'grid',
                gridTemplateColumns: '1fr 1fr',
